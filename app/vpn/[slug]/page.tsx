...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
    ...
    return {
        title: `${post?.title || 'Post'} - Best VPN Software`,
        description: post?.description,
    };
}

export default async function VpnPostPage({ params }: Props) {
    const { slug } = await params;
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                        ...
                        <div className="lg:col-span-2 space-y-8">
                            <div className="bg-zinc-900/40 border border-amber-900/10 rounded-2xl p-8 backdrop-blur-sm">
                                <h2 className="text-2xl font-bold text-amber-500 mb-4">Privacy & Protection</h2>
                            ...
                            <div className="bg-zinc-900/40 border border-amber-900/10 rounded-2xl p-8 backdrop-blur-sm">
                                <h2 className="text-2xl font-bold text-amber-500 mb-6">Security Features</h2>
                        ...
                        <div className="space-y-6">
                            <div className="bg-amber-500/5 border border-amber-500/20 rounded-2xl p-6 sticky top-24">
                                <h3 className="text-xl font-bold text-amber-500 mb-4">Secure Link</h3>
                                <a
                                ...
                                <p className="text-zinc-500 text-sm mt-4 text-center">
                                    Encrypted tunnel for your global internet access.
                                </p>
                            </div>
                        </div>
                    </div>
