...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
    ...
    const post = categories.flatMap(c => c.posts).find(p => p.slug === slug);

    return {
        title: `${post?.title || 'Post'} - Social Analytics`,
                ...
                <article className="space-y-12">
                    ...
                    <div className="relative h-[400px] w-full rounded-3xl overflow-hidden border border-amber-900/20 shadow-2xl">
                        ...
                        <div className="absolute bottom-8 left-8 right-8">
                            <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-4 tracking-tight">{post.title}</h1>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                        ...
                        <div className="lg:col-span-2 space-y-8">
                            <div className="bg-zinc-900/40 border border-amber-900/10 rounded-2xl p-8 backdrop-blur-sm">
                                <h2 className="text-2xl font-bold text-amber-500 mb-4">Complete Guide</h2>
                                <div className="text-zinc-300 leading-relaxed text-lg whitespace-pre-wrap prose prose-invert max-w-none">
                                    {post.content}
                                </div>
                            </div>

                            <div className="bg-zinc-900/40 border border-amber-900/10 rounded-2xl p-8 backdrop-blur-sm">
                                <h2 className="text-2xl font-bold text-amber-500 mb-6">Key Highlights</h2>
                        ...
                        <div className="space-y-6">
                            <div className="bg-amber-500/5 border border-amber-500/20 rounded-2xl p-6 sticky top-24">
                                <h3 className="text-xl font-bold text-amber-500 mb-4">Explore More</h3>
                                <Link
                                    href="/social"
                                ...
                                <p className="text-zinc-500 text-sm mt-4 text-center">
                                    Check out our other social media analysis and growth guides.
                                </p>
                            </div>
                        </div>
                    </div>
